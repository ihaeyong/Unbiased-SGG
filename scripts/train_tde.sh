...
if [ $2 == "sgcls" ]; then
    python -m torch.distributed.launch \
           ...
           OUTPUT_DIR ./checkpoints/rel_obj_scale4_sigma3_false2.5_sum_v3-sgcls
    ...
    python -m torch.distributed.launch \
           ...
           GLOVE_DIR ./datasets/glove \
           MODEL.PRETRAINED_DETECTOR_CKPT ./checkpoints/pretrained_faster_rcnn/model_final.pth \
           OUTPUT_DIR ./checkpoints/rel_obj_scale4_sigma3_false2.5_sum_v3-predcls
    ...
    python -m torch.distributed.launch \
           ...
           GLOVE_DIR ./datasets/glove \
           MODEL.PRETRAINED_DETECTOR_CKPT ./checkpoints/pretrained_faster_rcnn/model_final.pth \
           OUTPUT_DIR ./checkpoints/rel_scale4_sigma3_false2.5_sum_v3-sgdet
fi
