...
if [ $2 == "sgcls" ]; then
    python -m torch.distributed.launch \
           ...
           OUTPUT_DIR ./checkpoints/post0.02_non_skip_relu_full_mps1_s2_p0.03_pw0.5_obj2.2_rel1.0_sum_v3-sgcls
    ...
    python -m torch.distributed.launch \
           ...
           GLOVE_DIR ./datasets/glove \
           MODEL.PRETRAINED_DETECTOR_CKPT ./checkpoints/pretrained_faster_rcnn/model_final.pth \
           OUTPUT_DIR ./checkpoints/post0.02_non_skip_relu_full_mps1_s2_p0.03_pw0.5_obj2.2_rel1.0_sum_v3-predcls
    ...
    python -m torch.distributed.launch \
           ...
           GLOVE_DIR ./datasets/glove \
           MODEL.PRETRAINED_DETECTOR_CKPT ./checkpoints/pretrained_faster_rcnn/model_final.pth \
           OUTPUT_DIR ./checkpoints/post0.02_non_skip_relu_full_mps1_s2_p0.03_pw0.5_obj2.2_rel1.0_sum_v3-sgdet
