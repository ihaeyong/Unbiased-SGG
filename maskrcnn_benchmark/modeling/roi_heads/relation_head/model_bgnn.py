...
class BGNNContext(nn.Module):
    def __init__(
        ...
        self.pretrain_pre_clser_mode = False # added by haeyong.k
    ...
    def prepare_message(
        ...
        if select_mat.sum() == 0:
            ...
            aggregate_feat[vaild_aggregate_idx] /= avg_factor[vaild_aggregate_idx].half()
    ...
    def forward(
        ...
        if (
            ...
            len(relatedness_each_iters) > 0 and not self.training and self.rel_aware_on # modified by haeyong.k
