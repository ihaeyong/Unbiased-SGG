...
class ROIRelationHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None, logger=None):
        ...
        obj_refine_logits, relation_logits, add_losses, freq_bias = self.predictor(
            proposals,
            rel_pair_idxs,
            rel_pn_labels,
            gt_rel_binarys_matrix,
        ...
        loss_relation, loss_refine = self.loss_evaluator(
            proposals, rel_labels, relation_logits, obj_refine_logits, freq_bias
        )
